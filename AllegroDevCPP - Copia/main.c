...
int main(){
    ...
    //Variáveis
    int xboneco, yboneco, mortes = 0, xboneco2, hori = 5, verti = 5, vertibuff = 10, vertinegativo = 5, velBoneco = 3, sai = 0;
    float x= 10, y = 10 ;
	...
	while (!exit_program){	
		//MENU START
		while(!key[KEY_SPACE] || !exit_program){
